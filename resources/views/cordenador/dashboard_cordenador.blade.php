...
<body>
    ...
    <main>
        <section id="esquerda">
            ...
            <a href="/cordenador/analisar_turma">
                <button type="submit">
            ...
            <a href="/cordenador/add_refeicoes">
                <button type="submit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="78" height="79" viewBox="0 0 78 79" fill="none">
