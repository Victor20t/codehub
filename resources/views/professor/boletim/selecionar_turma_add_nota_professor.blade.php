...
<body>
    <nav class="navbar">
        <div class="container-nav">
            ...
            <ul class="menu">
                ...
                <li class="colornav"><a href="/professor/selecionar_turma_boletim">Add Boletim</a></li>
    ...
    <div class="container">
        ...
        <ul>
            @for($i = 1; $i < 10; $i++)
            <li><a href="/professor/add_boletim">{{ $i }}º ANO - TDS{{ $i }}IN-B - ESCOLA TECNICA ESTADUAL MINISTRO FERNANDO LYRA</a></li>
            @endfor
